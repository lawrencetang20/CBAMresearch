...
other_countries = {'USA', 'CAN', 'MEX', 'BRA', 'IND', 'CHN', 'RUS'} # to add another country, add here and BELOW
...
destinations = ['USA', 'CAN', 'MEX', 'BRA', 'IND', 'CHN', 'RUS', 'EU', 'ROW'] # ADD HERE FOR NEW COUNTRY TOO
